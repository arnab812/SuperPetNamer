# OpenAI API Quickstart - Node.js SuperPetNamer app
...
You should now be able to access the app at [http://localhost:3000](http://localhost:3000)! For the full context behind this SuperPetNamer app, check out - .
